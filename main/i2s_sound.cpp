...
*/
        ...
        // One word wasn't enough, this is more than DMA buffers....
...
void i2s_init(void)
{
    ...
    i2s_pdm_tx_config_t tx_pdm_cfg = {
        ...
        .gpio_cfg = {
            .clk = I2S_BCLK_IO1, // Must be included but mostly unused
            .dout = I2S_DOUT_IO1,
            .invert_flags = {
                .clk_inv = false,
            },
    ...
    ESP_ERROR_CHECK(i2s_channel_init_pdm_tx_mode(tx_chan, &tx_pdm_cfg));
#else
    i2s_std_config_t tx_std_cfg = {
        .clk_cfg  = I2S_STD_CLK_DEFAULT_CONFIG(16000), // ext_clk_freq_hz missing but not needed
